...
const DEFS: LocalAchievementDef[] = [
  ...
  { id: 'world_traveler',title: 'World Traveler',     description: 'Visit all 6 zones.',          icon: '🌍', category: 'exploration', points: 5, goal: 6   },
  { id: 'zone_clearer',  title: 'Zone Clearer',       description: 'Complete 3 different zones.', icon: '✓', category: 'exploration', points: 3, goal: 3   },
  { id: 'completionist', title: 'Completionist',      description: 'Complete all 6 zones.',       icon: '🏆', category: 'exploration', points: 7, goal: 6   },
  // Crafting
