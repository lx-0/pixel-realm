...
const DEFS: LocalAchievementDef[] = [
  ...
  { id: 'world_traveler',title: 'World Traveler',     description: 'Visit all 13 zones.',         icon: '🌍', category: 'exploration', points: 5, goal: 13  },
  { id: 'zone_clearer',  title: 'Zone Clearer',       description: 'Complete 3 different zones.', icon: '✓', category: 'exploration', points: 3, goal: 3   },
  { id: 'completionist', title: 'Completionist',      description: 'Complete all 13 zones.',      icon: '🏆', category: 'exploration', points: 7, goal: 13  },
  // Crafting
