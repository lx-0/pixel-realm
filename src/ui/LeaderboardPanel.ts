...
export type LeaderboardCategory = 'xp' | 'achievements' | 'prestige' | 'pvp_wins' | 'guild' | 'gvg' | 'hardcore';
...
const CATEGORIES: LeaderboardCategory[] = ['xp', 'achievements', 'prestige', 'pvp_wins', 'guild', 'gvg', 'hardcore'];
